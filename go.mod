...
require (
	...
	github.com/cloudwego/eino-ext/components/indexer/es8 v0.0.0-20251229121631-716047332ba5
	github.com/cloudwego/eino-ext/components/retriever/es8 v0.0.0-20251229121631-716047332ba5
